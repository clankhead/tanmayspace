...
Real-time encrypted messaging with user login, online user listing, and peer-to-peer communication.

Built-in rate limiting and simple command interface ensure secure and controlled interaction.
